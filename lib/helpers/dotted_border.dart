...
class DottedBorderCorner {
  ...
  DottedBorderCorner.all(double radius)
...
class DottedBorder extends StatefulWidget {
  ...
  /// If there is only [height] and no [width], you will get a dotted line in
  /// the vertical direction
  final double height;

  /// If there is only [width] and no [height], you will get a dotted
  ...
  /// The corners of the dotted border. See [DottedBorderCorner] for details
  final DottedBorderCorner corner;

  /// If [child] is set, [DottedBorder] will serve as the dotted border of [child].
  /// At this time, [width] and [height] will no longer be valid.
  final Widget child;

  /// [DottedBorder] provides developers with the ability to create dashed
  /// lines. It also supports creating a dashed border for a [Widget]. Support
  /// for controlling the thickness, spacing, and corners of the dotted border.
  DottedBorder({
    Key key,
